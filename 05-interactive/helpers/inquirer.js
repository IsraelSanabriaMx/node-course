  ...
  const questions = [
    {
      ...
      choices: [
        {
          value: '1',
          name: `${colors.red('1.')} Create task`,
        },
        {
          value: '2',
          name: `${colors.red('2.')} List tasks`,
        },
        {
          value: '3',
          name: `${colors.red('3.')} List completed tasks`,
        },
        {
          value: '4',
          name: `${colors.red('4.')} List pendant tasks`,
        },
        {
          value: '5',
          name: `${colors.red('5.')} Mark task as done`,
        },
        {
          value: '6',
          name: `${colors.red('6.')} Delete task`,
        },
        {
          value: '0',
